...
<div align="center">
  <h1>✨ Mahdi Karimi — Portfolio</h1>
  <p><strong>A world-class, Awwwards-inspired portfolio website built with modern web technologies</strong></p>
  <p>
...
- 🎨 **Premium Design** — Glassmorphism, dynamic gradients, and micro-interactions
- ⚡ **Lightning Fast** — Optimized for Core Web Vitals with 138KB gzipped bundle
...
src/
├── components/
│   ├── effects/          # Visual effects (GridBackground)
...
**Mahdi Karimi** — Creative Developer & Digital Architect

- 📧 Email: [themahdikga@gmail.com](mailto:themahdikga@gmail.com)
- 🐙 GitHub: [@mahdi8p2gi](https://github.com/mahdi8p2gi)
